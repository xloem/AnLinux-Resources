...
if [ "$first" != 1 ];then
	if [ ! -f $tarball ]; then
		...
		*)
		...
		wget -c "https://raw.githubusercontent.com/EXALAB/AnLinux-Resources/master/Rootfs/openSUSE/Tumbleweed/${archurl}/openSUSE-Tumbleweed-rootfs-${archurl}.tar.xz" -O "$tarball".inprogress
